        ...
        this._draw = function() {
            ...
            e._canvasCtx.fillStyle = 'rgb(0, 0, 0)';
              e._canvasCtx.fillRect(0, 0, window.innerWidth, window.innerHeight);
                const barWidth = (window.innerWidth / e._dataspec2) * 2.5;
              let posX = 0;
              for (let i = 0; i < e._dataspec2; i++) {
                const barHeight = (e._dataspec[i] + 140) * 2;
                e._canvasCtx.fillStyle = 'rgb(' + Math.floor(barHeight + 100) + ', 50, 50)';
                e._canvasCtx.fillRect(posX, window.innerHeight - barHeight / 2, barWidth, barHeight / 2);
                posX += barWidth + 1;
              },
