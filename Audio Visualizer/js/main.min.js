...
WebAudioManager = function() {
    ...
    t.prototype.load = function(t) {
        document.getElementById('first').addEventListener('click', this._webAudioPlayer.load("songs/Taska Black x DROELOE - Running Away (ft. CUT_)", true)),
        document.getElementById('second').addEventListener('click', this._webAudioPlayer.load("songs/Avicii - SOS ft. Aloe Blacc [Lyric Video]", true)),
