...
Main = function() {
    ...
    t.prototype._initWebGL = function() {
        ...
        // this.vertexShader = this._context.createShader(this._context.VERTEX_SHADER),
        // this.fragmentShader = this._context.createShader(this._context.FRAGMENT_SHADER),
        // this._context.shaderSource(this.vertexShader, document.getElementById("vs")),
        // this._context.shaderSource(this.fragmentShader, document.getElementById("fs")),

        // this._context.compileShader(this.vertexShader),
        // this._context.compileShader(this.fragmentShader),

        this._context.attachShader(this._program, this._addVertextShader(document.getElementById("vs"))),
        this._context.attachShader(this._program, this._addFragmentShader(document.getElementById("fs"))),
        // this._program.addVertexShader("vs", document.getElementById("vs"))
        // this._program.addFragmentShaderScript("fs"),
        console.log(this._context.getShaderInfoLog(this.vertexShader)),
        console.log(this._context.getShaderInfoLog(this.fragmentShader)),
