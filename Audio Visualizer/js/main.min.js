...
Main = function() {
    function t() {
        ...
        ,
        // this.fromHex = function(z, r) {
        //         var n;
        //         return n = new t,
        //         n.a = void 0 != r ? r : 1,
        //         n.r = ((16711680 & z) >> 16) / 255,
        //         n.g = ((65280 & z) >> 8) / 255,
        //         n.b = (255 & z) / 255,
        //         n
        //     }
        // ,
        // this.clearColorBuffer = function(z, r, n, o) {
        //     var i;
        //     void 0 != z && (void 0 != r ? void 0 != n ? e._context.clearColor(z, r, n, o) : 
        //         (e._context.clearColor(((16711680 & z) >> 16) / 255, ((65280 & z) >> 8) / 255, (255 & z) / 255, 1)) : 
        //         (e._context.clearColor(i.r, i.g, i.b, i.a))),
        //     e._context.clear(e._context.COLOR_BUFFER_BIT)
        // }
        // ,
        this._draw = function() {
            var i, o;
            ...
            e._context.clearColor(((16711680 & 3355443) >> 16) / 255, ((65280 & 3355443) >> 8) / 255, (255 & 3355443) / 255, 1),
            e._context.clear(e._context.COLOR_BUFFER_BIT),
            //e.clearColorBuffer(3355443, 1),
            ...
            e._context.uniformMatrix4fv(e._context.getUniformLocation(e._program, "matrix"), !1, i),
            e._context.uniform1f(e._context.getUniformLocation(e._program, "offset"), e._offset * t._DEGREES_TO_RADIANS),
            e._context.uniform1f(e._context.getUniformLocation(e._program, "strength"), e._strength),
            //e._uniform.setMatrix(e._context.getUniformLocation(e._program, "matrix"), 4, i),
            // e._uniform.setFloat(e._context.getUniformLocation(e._program, "offset"), e._offset * t._DEGREES_TO_RADIANS),
            // e._uniform.setFloat(e._context.getUniformLocation(e._program, "strength"), e._strength),
        ...
        this._onResize = function() {
            ...
            this._context.viewport(0, 0, t, i)
            //e._context.setSize(t, i),
            e._perspectiveMatrix = new Float32Array([r, 0, 0, 0, 0, n, 0, 0, 0, 0, 1e3 / (.1 - 1e3), -1, 0, 0, .1 * 1e3 / (.1 - 1e3), 0]),
            e._context.uniformMatrix4fv(e._context.getUniformLocation(e._program, "perspectiveMatrix"), !1, e._perspectiveMatrix)
            //e._uniform.setMatrix(e._context.getUniformLocation(e._program, "perspectiveMatrix"), 4, e._perspectiveMatrix)
        }
        ,
    ...
    ,
    t.prototype._add = function(t, e, r) {
            var n, o;
            n = this._context,
        ...
        ,
        t.prototype._setAttribPointer = function(t, e, r, n, o, i, u) {
            var c, a;
            c = this._context,
        ...
        ,
        t.prototype._add2 = function(t, e, r) {
            var n, o;
            n = this._context,
            o = this._bufferList2[t],
            null != o && n.deleteBuffer(o),
            o = n.createBuffer(),
            r != n.STREAM_DRAW && r != n.DYNAMIC_DRAW && (r = n.STATIC_DRAW),
            ...
            this._bufferList2[t] = o
        }
        ,
        t.prototype._addVertexShader = function(e) {
            var r;
            r = this._context,
            this._vertexShader = r.createShader(r.VERTEX_SHADER),
            r.shaderSource(this._vertexShader, e),
            r.compileShader(this._vertexShader),
            r.getShaderParameter(this._vertexShader, r.COMPILE_STATUS) ? this._vertexShaderList[t] = this._vertexShader : console.log("can not compile vertex shader. InfoLog: " + r.getShaderInfoLog(this._vertexShader))
        }
        ,
        t.prototype._addFragmentShader = function(e) {
            var r;
            r = this._context,
            this._fragmentShader = r.createShader(r.FRAGMENT_SHADER),
            r.shaderSource(this._fragmentShader, e),
            r.compileShader(this._fragmentShader),
            r.getShaderParameter(this._fragmentShader, r.COMPILE_STATUS) ? this._fragmentShaderList[t] = this._fragmentShader : console.log("can not compile fragment shader. InfoLog: " + r.getShaderInfoLog(this._fragmentShader))
        }
        ,
    ...
    t.prototype._initWebGL = function() {
        ...
        // this._addVertexShader(document.getElementById("vs")),
        // this._addFragmentShader(document.getElementById("fs")),
        ...
        console.log(document.getElementById("vs").text),
        this._context.shaderSource(this._vertexShader, document.getElementById("vs").text),
        this._context.shaderSource(this._fragmentShader, document.getElementById("fs").text),

        this._context.compileShader(this._vertexShader),
        this._context.compileShader(this._fragmentShader),
        console.log(this._context.getShaderInfoLog(this._vertexShader)),
           console.log(this._context.getShaderInfoLog(this._fragmentShader)), 
        this._context.attachShader(this._program, this._vertexShader),
        this._context.attachShader(this._program, this._fragmentShader),
        // this._program.add_VertexShader("vs", document.getElementById("vs"))
        // this._program.add_FragmentShaderScript("fs"),
        this._context.linkProgram(this._program),
        console.log(this._context.getProgramInfoLog(this._program)),
        //this._program.setProgram("vs", "fs"),
        this._initModel(),
        //this._vertexBuffer = this._context.createVertexBuffer(),
        this._add("vertex", this._vertexList, this._context.STATIC_DRAW),
        //this._context.getAttribLocation(this._program, "aPosition")
        //this._setAttribPointer("vertex", this._context.getAttribLocation(this._program, "aPosition"), 3, this._context.FLOAT, false, 24, 0),
        // this._setAttribPointer("vertex", this._context.getAttribLocation(this._program, "aLength"), 1, this._context.FLOAT, false, 24, 12),
        // this._setAttribPointer("vertex", this._context.getAttribLocation(this._program, "aUv"), 2, this._context.FLOAT, false, 24, 16),

        //this._indexBuffer = this._context.createIndexBuffer(),
        this._add2("index", this._indexList, this._context.STATIC_DRAW),
        this._context.bindBuffer(this._context.ELEMENT_ARRAY_BUFFER, this._bufferList2["index"]),
        this._initTexture()
    ...
    ,
    // t.prototype._initWebGL = function() {
    //     this._context.context.enable(this._context.context.DEPTH_TEST),
    //     this._context.context.depthFunc(this._context.context.LEQUAL),
    //     this._program = this._context.createProgram(),
...
,
t.prototype._isPowerOf2 = function(value) {
  return (value & (value - 1)) == 0;
    ...
    t.prototype._initTexture = function() {
        ...
        this._context.texImage2D(this._context.TEXTURE_2D, 0, this._context.RGBA, this._context.RGBA, this._context.UNSIGNED_BYTE, this._queue.getResult("images/lmao4.jpg")),
        ...
        this._context.texParameteri(this._context.TEXTURE_2D, this._context.TEXTURE_MIN_FILTER, this._context.LINEAR_MIPMAP_LINEAR), 
        this._context.bindTexture(this._context.TEXTURE_2D, this._texture),
        this._context.uniform1i(this._context.getUniformLocation(this._program, "texture"), 0),
        this._context.bindTexture(this._context.TEXTURE_2D, null),
        this._context.bindTexture(this._context.TEXTURE_2D, this._texture),
        this._context.texParameteri(this._context.TEXTURE_2D, this._context.TEXTURE_WRAP_S, this._context.MIRRORED_REPEAT),
        this._context.texParameteri(this._context.TEXTURE_2D, this._context.TEXTURE_WRAP_T, this._context.MIRRORED_REPEAT),
        this._context.bindTexture(this._context.TEXTURE_2D, null),
        this._context.bindTexture(this._context.TEXTURE_2D, this._texture)
        ...
        //this._texture.setParameterWrapST("texture", this._context.context.MIRRORED_REPEAT),
