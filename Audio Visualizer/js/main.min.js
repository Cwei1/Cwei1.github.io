...
Main = function() {
    ...
    t.prototype._initWebGL = function() {
        ...
        this._setAttribPointer("vertex", this._program.getAttribLocation("aPosition"), 3, this._context.FLOAT, false, 24, 0),
        this._setAttribPointer("vertex", this._program.getAttribLocation("aLength"), 1, this._context.FLOAT, false, 24, 12),
        this._setAttribPointer("vertex", this._program.getAttribLocation("aUv"), 2, this._context.FLOAT, false, 24, 16),
