WebAudioPlayer = function() {
    function t() {
        ...
        document.getElementById('first').addEventListener('click', this._toggle);
    ...
    ,
    t.prototype.retdata = function(){
        return this._spectrumList
    }
    ,
    t.prototype.retdata2 = function(){
...
WebAudioManager = function() {
    ...
    t.prototype.load = function(t) {
        ...
        if(t == 1)
            this._webAudioPlayer.load("songs/Taska Black x DROELOE - Running Away (ft. CUT_).mp3", true);
        this.analyseData = 0
    }
    ,
    t.prototype.retspec = function(){
        return this._webAudioPlayer.retdata()
    }
    ,
     t.prototype.retspec2 = function(){
        return this._webAudioPlayer.retdata2()
    }
    ,
    t.prototype.analyse = function() {
        var t, e, i, o, n, r, a;
...
Main = function() {
    function t() {
        ...
        this._barHeight,
        this._barWidth,
        this._canvas2 = document.getElementById("wgl2"),
        this._canvasCtx = e._canvas2.getContext('2d'),
        this._init = function() {
            $("#wgl").fadeIn(300),
        ...
        this._draw = function() {
            ...
            e._isPlaying ? (WebAudioManager.instance.analyse(),
                e._dataspec = WebAudioManager.instance.retspec(),
                e._dataspec2 = WebAudioManager.instance.retspec2(),
                console.log(e._dataspec),

            e._canvasCtx.fillStyle = 'rgb(0, 0, 0)',
              e._canvasCtx.fillRect(0, 0, window.innerWidth, window.innerHeight),
              e._barWidth = (window.innerWidth / e._dataspec2) * 2.5,
              e._posX = 0,
              for (let i = 0; i < e._dataspec2; i++) {
                e._barHeight = (e._dataspec[i] + 140) * 2,
                e._canvasCtx.fillStyle = 'rgb(' + Math.floor(e._barHeight + 100) + ', 50, 50)',
                e._canvasCtx.fillRect(e._posX, window.innerHeight - e._barHeight / 2, e._barWidth, e._barHeight / 2),
                e._posX += e._barWidth + 1,
              },
        ...
        ,
        this._changesong = function(t){
            e._indexSound = t;
        }
        ,
        this._onClickButton = function(t) {
            // document.getElementById('first').addEventListener('click', e._changesong(0)),
            // console.log("SONG ONE"),
            // document.getElementById('second').addEventListener('click', e._changesong(1)),
            // console.log("SONG TWO"),
            e._indexSound = e._jqueryButton.index(t.currentTarget),
            console.log(e._indexSound),
            e._change()
        }
