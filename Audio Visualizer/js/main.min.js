...
Main = function() {
    function t() {
        ...
        this._draw = function() {
            ...
            e._context.context.drawElements(e._context.context.TRIANGLES, e._indexList.length, e._context.UNSIGNED_SHORT, 0),
    ...
    const texture = this._context.createTexture();
      ...
      // Until then put a sinthis._contexte pixel in the texture so we can
      // use it immediately. When the image has finished downloading
      // we'll update the texture with the contents of the image.
      const level = 0;
      const internalFormat = this._context.RGBA;
      const width = 1;
      const height = 1;
      const border = 0;
      const srcFormat = this._context.RGBA;
      const srcType = this._context.UNSIGNED_BYTE;
      const pixel = new Uint8Array([0, 0, 255, 255]);  // opaque blue
      this._context.texImage2D(this._context.TEXTURE_2D, level, internalFormat,
    ...
    // Webthis._context1 has different requirements for power of 2 images
...
t.prototype._isPowerOf2 = function(value) {
  return (value & (value - 1)) == 0;
    ...
    t.prototype._initTexture = function() {
        ...
        this._context.bindTexture(this._context.TEXTURE_2D, this._texture),
        this._context.texParameteri(this._context.TEXTURE_2D, this._context.TEXTURE_WRAP_S, this._context.context.MIRRORED_REPEAT),
        this._context.texParameteri(this._context.TEXTURE_2D, this._context.TEXTURE_WRAP_T, this._context.context.MIRRORED_REPEAT),
        this._context.bindTexture(this._context.TEXTURE_2D, null),
        this._context.bindTexture(this._context.TEXTURE_2D, this._texture)
